<template>
	<div id="app">
		<base-button id="upButton" @click="goToTop">Up</base-button>
		<Header />
		<Intro />
		<base-breaker symbol="helmet" />
		<first-section />
		<base-breaker symbol="hammer" />
		<base-motto
			:motto="$t('workMotto')"
			:mottoAuthor="$t('workMottoAuthor')"
		/>
		<base-breaker symbol="saw" />
		<second-section />
		<base-breaker symbol="microbe" />
		<third-section />
	</div>
</template>
